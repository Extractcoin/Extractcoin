...
class TxnMallTest(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # Extractcoin: start with joined network, split after initial balances setup
        return super(TxnMallTest, self).setup_network(False)

    def run_test(self):
        # Extractcoin: burn 43750 coins on every node to match original test start conditions.
        # Fees going to node2.
        for n in range(4):
            burn = 45000-1250
        ...
        outputs[node1_address] = 1210 - 1 #Extractcoin: add fee
