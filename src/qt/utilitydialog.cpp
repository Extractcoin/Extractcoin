    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Extractcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Extractcoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Extractcoin Core is shutting down...") + "<br /><br />" +
